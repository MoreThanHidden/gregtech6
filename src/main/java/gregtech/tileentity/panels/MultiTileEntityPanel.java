...
public abstract class MultiTileEntityPanel extends TileEntityBase03MultiTileEntities implements IMTE_CanPlace {
	@Override public boolean canPlace(ItemStack aStack, PlayerEntity aPlayer, World aWorld, int aX, int aY, int aZ, byte aSide, float aHitX, float aHitY, float aHitZ) {return F;}
