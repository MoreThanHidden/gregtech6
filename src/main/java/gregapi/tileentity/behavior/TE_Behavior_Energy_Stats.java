...
public class TE_Behavior_Energy_Stats extends TE_Behavior_Energy {
	...
	public TE_Behavior_Energy_Stats(TileEntity aTileEntity, CompoundNBT aNBT, TagData aEnergyType, TE_Behavior_Energy_Capacitor aStorage, long aSizeMin, long aSizeRec, long aSizeMax) {
